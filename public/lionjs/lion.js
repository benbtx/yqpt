...
Element.prototype.onserialize = function (key, value) {
    ...
    !(function (namespace) {
      ...
      */
            ...
            !(function (o) {
                ...
                can.setAttribute('id','sfyqcanvas');
            ...
            */
            this.remove = function (ele) {
                ...
                if (ele instanceof namespace.LinkElement) {
                    ...
                    //删除两端点的连线引用
                    removeCore(ele.startNode.lines, ele);
                    removeCore(ele.endNode.lines, ele);
                }
    ...
    !(function (namespace) {
        ...
        */
        function GeoElement() {
            ...
            data.highlightColor =  'rgba(255,0,0,0.7)';

            // data.highlightColor = "rgba(255,125,125,0.9)";
        ...
        */
        ...
        EndPoint.prototype.updateBounds = function (g) {
            ...
            if (this.parent instanceof namespace.LineElement) {
                ...
                px = this.scene.x;
                py = this.scene.y;
                this.drawBounds.x = (this.x + px) * this.scale; //* this.scale;
                this.drawBounds.y = (this.y + py) * this.scale;//* this.scale;
    ...
    !(function (namespace) {
        ...
        */
        ...
        //MixElement.prototype.fireHover = function (e) {
        //    var next = true;
        //    if (this.eventRoute) {
        //        for (var i = 0; i < this.elements.length; i++) {
        //            var mp = this.layer.getMousePoint();
        //            if (this.elements[i].testPoint(mp.x, mp.y)) {
        //                var rtv = this.elements[i].fireHover(e);
        //                if (rtv != undefined && rtv == false)
        //                    next = false;
        //            }
        //        }
        ...
        //    if (next)
        //        namespace.RectElement.prototype.fireHover.call(this, e);
        //}
